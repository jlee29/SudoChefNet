...
class EchoApi(remote.Service):
    ...
    def getId(self, request):
        return EchoResponse(content="acknowledged " + request.id)
    ...
    def echo_api_key(self, request):
        return EchoResponse(content=request.get_unrecognized_field_info('key')[0])
    ...
    @endpoints.method(
        ...
        # This method returns an Echo message.
        EchoResponse,
        path='echo/acknowledge',
        http_method='GET',
        name='echo_ack')
    def acknowledge(self, request):
        return EchoResponse(content="Acknowledged.")
